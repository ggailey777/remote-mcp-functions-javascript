...
async function getLatestObservationAsync(lat, lon) {
  try {
...
// Parse observation data to weather result
function parseObservation(props, location) {
...
class WeatherService {
   ...
   * @param {string} location - City name, address, or zip code
   * @returns {Promise<object>} Weather result on success, weather error on failure
   */
  async getCurrentWeatherAsync(location) {
