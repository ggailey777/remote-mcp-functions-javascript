<!--
---
name: Remote MCP with Azure Functions (Node.js/JavaScript)
...
- azure
page_type: sample
urlFragment: remote-mcp-functions-javascript
---
-->
# Getting Started with Remote MCP Servers using Azure Functions (Node.js/JavaScript)
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/Azure-Samples/remote-mcp-functions-javascript)
...
1. In Copilot chat agent mode enter a prompt to trigger the tool, e.g., select some code and enter this prompt
    ...
    ```plaintext
    Retrieve snippet1 and apply to newFile.js
    ```
...
The function code for the `getSnippet` and `saveSnippet` endpoints are defined in the JavaScript files in the `src` directory. The MCP function annotations expose these functions as MCP Server tools.
...
async function getSnippet(_message, context) {
...
async function saveSnippet(_message, context) {
...
- Learn more about the [Azure Functions MCP extension](https://learn.microsoft.com/azure/azure-functions/functions-bindings-mcp?pivots=programming-language-javascript)
